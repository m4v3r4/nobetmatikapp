...
import 'package:nobetmatik/services/ads/ads_service.dart';
...
void main() {
  testWidgets('Nobetmatik aciliyor', (tester) async {
    ...
    await tester.pumpWidget(
      NobetmatikApp(controller: controller, adsService: adsService),
    );
    expect(find.text('Nobetmatik'), findsOneWidget);
  });
}
